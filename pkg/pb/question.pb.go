...
var file_question_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x56, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xb5, 0x04, 0x0a, 0x0f, 0x51, 0x75,
	0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2e, 0x0a,
...
var file_question_proto_depIdxs = []int32{
	...
	8,  // 14: QuestionService.ValidQuestion:input_type -> ValidQuestionRequest
	9,  // 15: QuestionService.ListQuestionPage:input_type -> GetQuestionPageRequest
	4,  // 16: QuestionService.AddQuestion:input_type -> QuestionAddRequest
	11, // 17: QuestionService.GetQuestionVoById:input_type -> QuestionIdRequest
	11, // 18: QuestionService.GetQuestionById:input_type -> QuestionIdRequest
	11, // 19: QuestionService.DeleteQuestionById:input_type -> QuestionIdRequest
	0,  // 20: QuestionService.UpdateQuestion:input_type -> QuestionInfo
	0,  // 21: QuestionService.GetQuestionVo:input_type -> QuestionInfo
	16, // 22: QuestionService.GetQuestionTotal:input_type -> Empty
	9,  // 23: QuestionService.ListQuestionVoPage:input_type -> GetQuestionPageRequest
	16, // 24: QuestionService.ValidQuestion:output_type -> Empty
	10, // 25: QuestionService.ListQuestionPage:output_type -> GetQuestionPageResponse
	17, // 26: QuestionService.AddQuestion:output_type -> BoolResponse
	1,  // 27: QuestionService.GetQuestionVoById:output_type -> QuestionVo
	0,  // 28: QuestionService.GetQuestionById:output_type -> QuestionInfo
	17, // 29: QuestionService.DeleteQuestionById:output_type -> BoolResponse
	17, // 30: QuestionService.UpdateQuestion:output_type -> BoolResponse
	1,  // 31: QuestionService.GetQuestionVo:output_type -> QuestionVo
	18, // 32: QuestionService.GetQuestionTotal:output_type -> TotalResponse
	12, // 33: QuestionService.ListQuestionVoPage:output_type -> ListQuestionPageVoResponse
